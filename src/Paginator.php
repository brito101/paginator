...
class Paginator
{
    ...
    public function __construct(string $link = null, string $title = null, array $first = null, array $last = null)
    {
        ...
        $this->first = ($first ?? ["First page", "&lt;&lt;"]);
        $this->last = ($last ?? ["Last page", "&gt;&gt;"]);
    }
     ...
     * @param array $params
     */
    public function pager(int $rows, int $limit = 10, int $page = null, int $range = 2, string $hash = null, array $params = []): void
    {
